...
class PlayerActivity : AppCompatActivity() {
    ...
    private fun updatePlayPauseButton(isPlaying: Boolean) {
        ...
        if (isPlaying) {
            if (imgPlayerCover.animation == null) {
                val rotateAnim = AnimationUtils.loadAnimation(this, R.anim.rotate_cover)
                imgPlayerCover.startAnimation(rotateAnim)
            }
        } else {
            imgPlayerCover.clearAnimation()
        }
    }
