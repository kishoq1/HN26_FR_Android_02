package com.example.assignment6.ui.screen
...
import com.example.assignment6.viewmodel.ContactViewModel

@Composable
fun ContactScreen(viewModel: ContactViewModel) {
    // Đăng ký lắng nghe luồng RxJava và chuyển đổi thành State
    val contactList by viewModel.contacts.subscribeAsState(initial = emptyList())
...
fun ContactContent(
    ...
    // --- LOGIC KIỂM TRA TRÙNG LẶP & HỢP LỆ ---
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Quản lý danh bạ (Rx + Compose)") },
